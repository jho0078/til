...
// // exercise 1-2 아래 코드의 images 배열 안에 있는 정보(height, width)를 곱해 넓이를
// // 구하여 areas 배열에 저장하는 코드를 forEach 헬퍼를 사용해 작성해보자
// const images = [
//     { height: 10, width: 30 },
//     { height: 20, width: 90 },
//     { height: 54, width: 32 },
...
// exercise 2-2 map 헬퍼를 사용해, (distance / time) 을 저장하는 배열 speeds 를 만들어보자.
const trips = [
    { distance: 34, time: 10},
    { distance: 90, time: 50},
    { distance: 59, time: 25},    
...
// exercise 2-3 다음 두 배열을 객체로 결합은 comics 배열을 만들어봐자. (brands 요소가 key, moview 요소가 value)
